...
export default function BookSidebar({ book }: BookDetailsProps) {
  return (
    <div className="lg:col-span-5 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4 rounded-2xl border border-ivory-border bg-white p-6 shadow-sm dark:border-[#2A201B] dark:bg-[#1C1612]">
        <button
          type="button"
          className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-ivory-border px-4 py-3 text-sm font-medium text-walnut transition-all hover:border-bronze hover:bg-ivory-hover dark:border-[#2A201B] dark:text-zinc-200 dark:hover:border-gold dark:hover:bg-[#2A201B]"
        >
        ...
        <button
          type="button"
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-red-50 px-4 py-3 text-sm font-medium text-badge-borrowed transition-all hover:bg-red-100/80 dark:bg-red-950/20 dark:text-red-300 dark:hover:bg-red-950/40"
        >
          <Trash2 size={15} />
